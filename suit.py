...
def arguments():
    ...
    "loss_function_from_returns", "epochs", "grad_clip", "n_head",
     "input_normalization", "early_stopping_dist"], "test_requirement6"
...
def info_creator():
    ...
    # where to find data
    info['tickers_names_file_path'] = 'Data2/Bloomberg/tickers_custom_Equity'
    info['tickers_base_path'] = 'Data2/Bloomberg/Equity_directory3/'

    # features
    info['features_names_file_paths'] = ['Data2/Bloomberg/features_chap', 'Data2/Bloomberg/features_glauber']

    # optuna configuration
    info['num_shuffling'] = 3
    info['optuna_sampler'] = 'TPE'
    info['optuna_metric_name'] = 'sharpe_of_average_transaction_cost'
    info['optuna_n_jobs'] = 1

    # time stamps
    info['start_date'] = '1996-01-11'
    info['test_begin'] = '2011-10-28'
    info['validation_begin'] = '2014-09-11'
    info['end_date'] = '2021-02-18'
    ...
    # transaction cost
    info['test_transaction_cost'] =  np.full(shape=14, fill_value=1)
...
def search_space_creator(x):
    ...
    # regularization
    "train_transaction_cost_factor": x.suggest_uniform("train_transaction_cost_factor", 1, 10),
    "shrinkage" : x.suggest_categorical("shrinkage", [0.]),
    "dropout" : x.suggest_uniform("dropout", 0.3, 0.5),
    ...
    "early_stopping_dist" : x.suggest_categorical("early_stopping_dist", [15]),
