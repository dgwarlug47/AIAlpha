...
def search_space_creator(x):
    ...
    "dropout" : x.suggest_uniform("dropout", 0.1, 0.9),
    ...
    "type_net" : x.suggest_categorical("type_net", ["LSTM", "GRU"]),
    ...
    # epochs
    "epochs" : x.suggest_int("epochs", 15, 30),
    ...
    # bootstrapping
    "bootstrap_ratio" : x.suggest_categorical("bootstrap_ratio", [0.4]),
